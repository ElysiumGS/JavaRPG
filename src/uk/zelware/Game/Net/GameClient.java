...
import uk.zelware.Game.Game;
import uk.zelware.Game.Entities.PlayerMP;
import uk.zelware.Game.Net.Packets.Packet;
import uk.zelware.Game.Net.Packets.Packet.PacketTypes;
import uk.zelware.Game.Net.Packets.Packet00Login;
import uk.zelware.Game.Net.Packets.Packet01Disconnect;
import uk.zelware.Game.Net.Packets.Packet02Move;
...
//			System.out.println("SERVER > " + message);
	...
	private  void handleLogin(Packet00Login packet, InetAddress address, int port){
		...
		PlayerMP player = new PlayerMP(game.level, packet.getX(), packet.getY(), ((Packet00Login)packet).getUsername(), address, port);
