...
import uk.zelware.Game.Entities.Entity;
import uk.zelware.Game.Entities.PlayerMP;
import uk.zelware.Game.Level.Tiles.Tile;
...
public class Level {
	...
	public void removePlayerMP(String username) {
	        ...
	        for (Entity e : getEntities()) {
	            ...
	            index++;
	            System.out.println("Entity not at this index, trying again!");
	        }
	        System.out.println("Found entity! deleting");
